...
{
    public partial class CatCatalogue : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            /*
            string Display = "";
            int number_of_pets = SR1.NumberOfCats() + 1;
            // View Dynamic Content
            Display = "<form runat='server'  style='display: grid; grid-template-columns: repeat(auto-fit, minmax(30%, 30%)); grid-gap: 20px; justify-content:center;'> ";
            for (int k = 1; k < number_of_pets; k++)
            {
                ServiceReference1.TempData tempdata = SR1.GetCat(k);
